...
namespace DefineX.Services.ProductAPI.dbcontexts
{
   ...
   new ProductImage { variant_id = new[] { 101 }, id = 1, alt = "yellow", src = "1.png", image_id = 111 },
    new ProductImage { variant_id = new[] { 102 }, id = 1, alt = "white", src = "2.png", image_id = 112 },
    new ProductImage { variant_id = new[] { 201 }, id = 2, alt = "olive", src = "3.png", image_id = 211 },
    new ProductImage { variant_id = new[] { 202 }, id = 2, alt = "navy", src = "4.png", image_id = 212 },
     new ProductImage { variant_id = new[] { 301 }, id = 3, alt = "whredite", src = "5.png", image_id = 311 },
    new ProductImage { variant_id = new[] { 302}, id = 3, alt = "red", src = "6.png", image_id = 312 },
      new ProductImage { variant_id = new[] { 401 }, id = 4, alt = "green", src = "7.png", image_id = 411 },
    new ProductImage { variant_id = new[] { 403 }, id = 4, alt = "skyblue", src = "8.png", image_id = 412 },
     new ProductImage { variant_id = new[] { 501 }, id = 5, alt = "green", src = "9.png", image_id = 511 },
    new ProductImage { variant_id = new[] { 502 }, id = 5, alt = "black", src = "10.png", image_id = 512 },
       new ProductImage { variant_id = new[] { 601 }, id = 6, alt = "olive", src = "11.png", image_id = 611 },
    new ProductImage { variant_id = new[] { 602 }, id = 6, alt = "gray", src = "12.png", image_id = 612 },
     new ProductImage { variant_id = new[] { 1201 }, id = 12, alt = "red", src = "8.png", image_id = 1211 },
    new ProductImage { variant_id = new[] { 1202 }, id = 12, alt = "pink", src = "9.png", image_id = 1212 }
           );
